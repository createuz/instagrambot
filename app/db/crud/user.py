...
class UserService(CrudService):
    ...
    async def create(
        ...
        raw_code = aiogram_user.language_code
        print(raw_code)
        lang_code = normalize_locale(raw_code)
        print(i18n_core.available_locales)
        db_user: User = User(
            ...
            language=(
                lang_code
                if lang_code and lang_code in i18n_core.available_locales
                else DEFAULT_LOCALE
            ),
