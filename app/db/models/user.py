...
class User(Base, TimestampMixin):
    ...
    chat_id: Mapped[Optional[Int64]] = mapped_column(
    ...
    is_premium: Mapped[Optional[bool]] = mapped_column(
        Boolean, nullable=False, default=False
    )
    ref_by: Mapped[Optional[str]] = mapped_column(
        String(length=32), nullable=True, default="bot"
    )
