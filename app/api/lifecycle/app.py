...
from app.api import setup_fastapi
from app.api.lifecycle.lifespan import emit_aiogram_shutdown
from app.api.lifecycle.polling import polling_lifespan, polling_startup
from app.api.lifecycle.webhook import webhook_shutdown, webhook_startup
from app.bot.telegram.requests import TelegramRequestHandler
